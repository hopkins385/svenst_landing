<script setup lang="ts">
  definePageMeta({
    ...
    desription: 'imprint.meta.description',
  });
</script>
  ...
  <SectionContainer>
    <div class="grid lg:grid-cols-2">
      <div>
        ...
        <p class="pt-4">Sven Stadhouders</p>
        <p>Speditionstraße 15A</p>
        <p>40221 Düsseldorf</p>
        <p>GERMANY</p>
        <p class="py-4">Email: hi@svenson.ai</p>
        <p>VAT: DE366746015</p>
        <div class="pt-8 text-sm">
          <p class="pb-4 underline">Liability for content</p>
          <p>
            As a service provider, we are responsible for our own content on
            these pages in accordance with § 7 para.1 TMG under the general
            laws. According to §§ 8 to 10 TMG, however, we are not obligated as
          ...
          <p class="py-4 underline">Liability for links</p>
          <p>
          ...
          <p class="py-4 underline">Copyright</p>
          <p>
          ...
          <p class="py-4 underline">Dispute Resolution</p>
          <p>
            The European Commission provides a platform for online dispute
            resolution (OS): https://ec.europa.eu/consumers/odr. You can find
            our email address at the top of the imprint. We are not willing or
            obliged to participate in dispute resolution proceedings at a
